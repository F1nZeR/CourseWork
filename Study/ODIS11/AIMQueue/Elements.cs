...
namespace ODIS.AIM.Queue
{
    ...
    public abstract class Element
    {
        ...
        public abstract void Accept(Call call, Element source = null);
    ...
    public class Source : Element
    {
        ...
        {
            if (NextElement != null) NextElement.Accept(e.Call, this);
        }
    ...
    public class ServerBlock : Element
    {
        ...
        public ServerBlock(QueueSimulationModel model, RandomDistribution distribution = null, Element nextElement = null): base(model)
        {
